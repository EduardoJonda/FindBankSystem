   ...
   <div class="modal-content" id="modalcontenido" >
	...
	<table class="table">
		...
		<tr>
          ...
          <td><form:input class="form-control" path="tipo" size="30"></form:input></td>
		</tr>
		<tr>
		...
		<tr>
		  <td><form:label path="hora_ini">Hora inicial :</form:label></td>
          <td><form:input class="form-control" path="hora_ini" size="30" maxlength="30"  ></form:input></td>
		</tr>
		
		<tr>
		  <td><form:label path="hora_fin">Hora final:</form:label></td>
          <td><form:input class="form-control" path="hora_fin" size="30" maxlength="30"  ></form:input></td>
		</tr>
		<tr>
		  <td><form:label path="descripcion">descripcion:</form:label></td>
          <td><form:input class="form-control" path="descripcion" size="30" ></form:input></td>
       
		</tr> 
		  <tr>
		  <td><form:label path="imagen">imagen:</form:label></td>
          <td><form:select  class="form-control" path="imagen" items="${fotos}"/></td>
         </tr>
	 ...
	 <div class="modal-footer">
      ...
      <div class="card mb-3">
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0"  style="font-size:16px;">
              <thead>
                <tr>
                  ...
                  <th style="font-size:20px;">Hora inicio</th>
                  <th style="font-size:20px;">Hora final</th>
                  <th style="font-size:20px;">Descripcion</th>
                  <th style="font-size:20px;">Imagen</th>
                  <th colspan="2"></th> 
                </tr>
              </thead>
              ...
              <tbody> 
				...
				<tr>
					...
					<td style="font-size:16px;">${agentes.hora_ini}</td>
					<td style="font-size:16px;">${agentes.hora_fin}</td>
					<td style="font-size:16px;">${agentes.descripcion}</td>
					<td style="font-size:16px;">${agentes.imagen}</td>
        ...
        <div class="card-footer small text-muted"  style="font-size:18px;">Find Bank 2017</div>
      </div>
