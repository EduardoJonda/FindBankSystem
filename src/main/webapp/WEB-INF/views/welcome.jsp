                            ...
                            <div class="main">
                                <h4 class="text-center">${agentes.descripcion}</h4>
                                  ...
                                  <tr>
                                    ...
                                    <td>${agentes.hora_ini}</td>  
                                  </tr>
                                   <tr>
                                     <td>Horario fin:</td>
                                    <td>${agentes.hora_fin}</td> 
                                  </tr>
                                   <tr>
                                    <td><br></td> 
                                  </tr> 
 ...
 <script src="<c:url value="/resources/vendor/jquery/jquery.min.js"/>"></script>
  ...
  <div class="modal-dialog" role="document">
	...
	<table class="table"> 
		...
		<tr>
		  <td><form:label path="hora_ini">horario:</form:label></td>
          <td><form:input class="form-control" path="hora_ini" size="30" maxlength="30"></form:input></td>
		</tr>
		<tr>
		  <td><form:label path="hora_fin">horario:</form:label></td>
	...
	<table class="table"> 
		...
		<form:hidden path="id" />
          ...
          <td><form:hidden path="tipo"/></td> 
           <td><form:hidden path="seguridad"/></td>
           <td><form:hidden path="hora_ini"/></td>
           <td><form:hidden path="hora_fin"/></td>
